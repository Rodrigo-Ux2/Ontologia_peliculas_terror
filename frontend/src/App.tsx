...
const SEMANTIC_MONSTER_MAP: [string, string][] = [
  ['asesino serial', 'AsesinoSerial'], ['asesino en serie', 'AsesinoSerial'], ['serial killer', 'AsesinoSerial'],
  ['hombre lobo', 'HombreLobo'], ['werewolf', 'HombreLobo'], ['lobisomem', 'HombreLobo'],
  ['monstruo fisico', 'Monstruo_Fisico'], ['monstruo físico', 'Monstruo_Fisico'], ['physical monster', 'Monstruo_Fisico'],
  ['monstro', 'Monstruo_Fisico'],
  ['fantasma', 'Fantasma'], ['ghost', 'Fantasma'],
  ['demonio', 'Demonio'], ['demon', 'Demonio'],
  ['vampiro', 'Vampiro'], ['vampire', 'Vampiro'],
  ['zombi', 'Zombi'], ['zombie', 'Zombi'], ['zombies', 'Zombi'], ['zumbi', 'Zombi'],
  ['lobo', 'HombreLobo'],
  ['extraterrestre', 'Extraterrestre'], ['alien', 'Extraterrestre'],
  ['asesino', 'AsesinoSerial'],
  ['monstruo', 'Monstruo_Fisico'], ['monster', 'Monstruo_Fisico'],
];

const SEMANTIC_SUBGENERO_MAP: [string, string][] = [
  ['body horror', 'BodyHorror'],
  ['found footage', 'FoundFootage'],
  ['terror psicologico', 'TerrorPsicologico'], ['terror psicológico', 'TerrorPsicologico'],
  ['psychological', 'TerrorPsicologico'], ['psychological horror', 'TerrorPsicologico'],
  ['terror historico', 'TerrorHistorico'], ['terror histórico', 'TerrorHistorico'],
  ['historical horror', 'TerrorHistorico'],
  ['terror supervivencia', 'TerrorSupervivencia'],
  ['survival horror', 'TerrorSupervivencia'],
  ['comedia terror', 'ComediaTerror'], ['horror comedy', 'ComediaTerror'],
  ['slasher', 'Slasher'],
  ['sobrenatural', 'Sobrenatural'], ['supernatural', 'Sobrenatural'],
  ['psicologico', 'TerrorPsicologico'], ['psicológico', 'TerrorPsicologico'],
  ['supervivencia', 'TerrorSupervivencia'],
  ['historico', 'TerrorHistorico'], ['histórico', 'TerrorHistorico'],
  ['gore', 'BodyHorror'],
];
